...
extension UIView {
    ...
    private struct AssociatedKeys {
        static var topLeftCornerRadius: UInt8 = 0
        static var topRightCornerRadius: UInt8 = 0
        static var bottomLeftCornerRadius: UInt8 = 0
        static var bottomRightCornerRadius: UInt8 = 0
    }
